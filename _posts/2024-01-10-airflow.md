...
In section will be introduced key components of architecture
...
Moreover, it introduced convenient way of job execution defined by yaml:
...
job:
    ...
    excecution_time: # time of execution. After job ungracefully shuts

```
Therefore architecture was built for effective utilizations 

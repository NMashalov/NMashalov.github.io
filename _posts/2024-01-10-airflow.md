...
Such solutions allows to abstract from Airflow and can be scaled via interactive UI
...
bash util envsubst fills fields as `${PG_PASSWORD}` with respect value from Gitlab CI variables.
